...
is
   ...
   package Altitude_Pid is new Pid
     (LPS25h.T_Altitude'First,
      ...
      Float'First / 8.0,
      Float'Last / 8.0,
      Pid_Parameters.MIN_ALTITUDE_COEFF,
      Pid_Parameters.MAX_ALTITUDE_COEFF);
   ...
   procedure Init
     with
       Global => (In_Out => (Stabilizer_State,
                             ...
                             Controller.Attitude_PIDs,
                             Controller.Rate_PIDs));
   ...
   procedure Control_Loop
     ...
     with
       Global => (Input  => (V_Speed_Parameters,
                             ...
                             Alt_Hold_Parameters,
                             IMU.IMU_State,
                             Power_Management.Power_Management_State,
                             Ada.Real_Time.Clock_Time),
                  In_Out => (Commander.Commander_State,
                             CRTP.CRTP_State,
                             Free_Fall.FF_State,
                             Motors.Motors_State,
                             SensFusion6.SensFusion6_State,
                             IMU_Outputs,
                             Desired_Angles,
                             Desired_Rates,
                             Actual_Angles,
...
private
     ...
     with
       Global => (Input  => (Desired_Angles,
                  ...
                  Output => (Actual_Angles,
                             Desired_Rates),
                  In_Out => (SensFusion6.SensFusion6_State,
                             V_Speed_Variables,
                             Controller.Attitude_PIDs));
   ...
   Temperature  : LPS25h.T_Temperature := 0.0 --  Temperature
     with Part_Of => Asl_Variables;
   Pressure     : LPS25h.T_Pressure    := 1000.0
     with Part_Of => Asl_Variables;    --  Pressure from barometer
   Asl          : LPS25h.T_Altitude    := 0.0
     with Part_Of => Asl_Variables;    --  Smoothed asl
   Asl_Raw      : LPS25h.T_Altitude    := 0.0
     with Part_Of => Asl_Variables;    --  Raw asl
   Asl_Long     : LPS25h.T_Altitude    := 0.0
   ...
   Alt_Hold_PID_Val : LPS25h.T_Altitude := 0.0
   ...
   Alt_Hold_Change  : LPS25h.T_Altitude := 0.0
     with Part_Of => Alt_Hold_Variables; --  Change in target altitude.
   Alt_Hold_Target  : LPS25h.T_Altitude := -1.0
